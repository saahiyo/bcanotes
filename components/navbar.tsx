...
import { ArrowUpRight, BookOpen, FileText, FolderOpen, Home, Library, LogIn, LogOut, Menu, Heart, MessageSquare, User, Search, ChevronDown, Bell, Wrench } from "lucide-react";
...
export function Navbar() {
  ...
  const allNavLinks = [
    ...
    { href: "/notices", label: "Updates", icon: Bell },
