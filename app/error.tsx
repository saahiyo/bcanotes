  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden -z-10">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[400px] w-[400px] rounded-full bg-red-500/5 blur-[120px]" />
      </div>

      <div className="flex flex-col items-center gap-6 max-w-md">
        <div className="inline-flex h-20 w-20 items-center justify-center rounded-2xl bg-red-500/10 ring-1 ring-red-500/20">
